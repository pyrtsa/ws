  ...
  if (typeof listener === 'function') {
    if (method === 'message') {
      function onMessage (data, flags) {
        listener.call(this, new MessageEvent(data, flags.binary ? 'Binary' : 'Text'));
      }
...
function MessageEvent(dataArg, typeArg) {
  this.data = dataArg;
  this.type = typeArg;
}
...
function initAsClient(address, options) {
  ...
  requestHeaders['Host'] = headerHost;
  requestHeaders['Origin'] = headerHost;
